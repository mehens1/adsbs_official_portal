...
<html lang="en">
  <head>
    ...
    <title>404 - Not Found :: Adamawa State Bureau of Statistics</title>
            ...
            <div class="col-lg-7 mx-auto text-white">
              ...
              <div class="row mt-5">
                <div class="col-12 mt-xl-2">
                  <p class="text-white font-weight-medium text-center">Copyright © Adamawa State Bureau of Statistics {{ date('Y') }}</p>
                </div>
              </div>
            </div>
          </div>
