        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-sample" method="POST" action="{{ route('updatePriceWatch', ['id' => $data['price']['id'] ]) }}">
                        @csrf
                        @method('put')
                        <p class="card-description">  </p>
                        <div class="row">
                            <div class="col-12">
                                <label class="col-sm-3 col-form-label">Update Price Description</label>
                                <br>

                                <textarea id="editor" name="description">{{ $data['price']['description'] }}</textarea>
